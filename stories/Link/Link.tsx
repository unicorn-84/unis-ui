...
const classes = {
  primary: {
    ...
    contained:
      'inline-block rounded px-4 py-2 font-medium tracking-wide transition-colors bg-emerald-500 hover:bg-emerald-600 text-white border-2 border-emerald-500 hover:border-emerald-600 text-center',
    outlined:
  ...
  secondary: {
    ...
    contained:
      'inline-block rounded px-4 py-2 font-medium tracking-wide transition-colors bg-sky-500 hover:bg-sky-600 text-white border-2 border-sky-500 hover:border-sky-600 text-center',
    outlined:
  ...
  link: {
    ...
    contained:
      'inline-block rounded px-4 py-2 font-medium tracking-wide transition-colors bg-blue-500 hover:bg-blue-600 text-white border-2 border-blue-500 hover:border-blue-600 text-center',
    outlined:
